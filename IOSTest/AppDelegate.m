...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    DZWHomeViewController *rootVC = [[DZWHomeViewController alloc] init];
//    DZWNavigationController *nav = [[DZWNavigationController alloc] initWithRootViewController:rootVC];
